...
router.post('/',async function(req, res, next) {
  ...
  console.log("SELECT * FROM TeDetail WHERE sheet_year='"+year+"' AND sheet_month='"+tmonth+"' AND emp_no=(SELECT emp_no FROM Employee WHERE emp_no='"+account+"' AND pw='"+pass+"')");

  await client.connect()
  // console.log(client)
  client.query("SELECT * FROM TeDetail WHERE sheet_year='"+year+"' AND sheet_month='"+tmonth+"' AND emp_no=(SELECT emp_no FROM Employee WHERE emp_no='"+account+"' AND pw='"+pass+"')",function(err,result){
    if(err){
        console.log('error')
      }
      console.log(result)
