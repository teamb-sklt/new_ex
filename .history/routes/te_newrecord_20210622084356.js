...
router.post('/', async function(req,response,next){
        ...
        function searchPrice(){
            ...
            .then(res =>{     
                ...
                let opt = {
                    ...
                    date: date,
                    branch_no2:branch_no2,
                    sStart: req.body.trans_from,
                    sWaypoint: req.body.trans_waypoint,
                    sGoal: req.body.trans_to,
                };
    ...
    const values = ['dEmpno','year','tmonth','branch_no2','dYear','dMonth','dDay',dWay,dStart,dGoal,dWaypoint,dPrice,aTimes,dJobno,'dJobmanager','dClaimflag','dChargeflag','dRefno','dStasus',dMemo,'dNew','dNewdate','dNew','dNewdate'];
