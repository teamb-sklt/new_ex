...
router.post('/',async function(req,response,next){
    ...
    if(req.body.search){
        ...
        */
        ...
        function searchPrice(){
            ...
            //日付・時刻検索の条件を生成
            let dateUrl = '&date='+req.console.date;
            ...
            .then(res =>{     
                ...
                let opt = {
                    ...
                    moveDate: 'value='+'"'+req.console.date.substring(4)+'"', //データベースの値+この式でいけそう
                    date: req.console.date,
    ...
    // })
            ...
            let dShinsei =1;
            let dMovedate = req.console.date;
            let dUpdate =req.console.date;
