...
router.post('/', async function(req,response,next){
    ...
    const sql = "INSERT INTO TeDetail (emp_no, sheet_year, sheet_month, branch_no, year, month, day, trans_type, trans_from, trans_to, trans_waypoint, amount, count, job_no, job_manager, claim_flag, charge_flag, ref_no, status, remarks, new, new_date, renew, renew_date) VALUES ('"+dEmpno+"','"+year+"','"+tmonth+"','"+branch_no2+"','"+dYear+"','"+dMonth+"','"+dDay+"','"+dWay+"','"+dStart+"','"+dGoal+"','"+dWaypoint+"','"+dPrice+"','"+dTimes+"','"+dJobno+"','"+dJobmanager+"','"+dClaimflag+"','"+dChargeflag+"','"+dRefno+"','"+dStasus+"','"+dMemo+"','"+dNew+"','"+dNewdate+"','"+dNew+"','"+dNewdate+"') ; INSERT INTO TeComments (emp_no, sheet_year, sheet_month, branch_no, app_class, job_manager, app_flag, comment, new, new_date, renew, renew_date) VALUES ('"+dEmpno+"','"+year+"','"+tmonth+"','"+branch_no2+"','"+1+"','"+111+"','"+1+"','"+''+"','"+dNew+"','"+dNewdate+"','"+dNew+"','"+dNewdate+"')";
