...
router.post('/', async function(req,response,next){
    ...
    const sql = "INSERT INTO TeComments (emp_no, sheet_year, sheet_month, branch_no, app_class, job_manager, app_flag, comment, new, new_date, renew, renew_date) VALUES ('"+dEmpno+"','"+year+"','"+tmonth+"','"+branch_no2+"','"+1+"','"+111+"','"+1+"','"+''+"','"+dNew+"','"+dNewdate+"','"+dNew+"','"+dNewdate+"')";
