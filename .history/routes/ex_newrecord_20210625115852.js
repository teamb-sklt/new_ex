...
router.post('/', async function(req,response,next){
    ...
    const sql = "INSERT INTO ExDetail (emp_no, sheet_year, sheet_month, branch_no, year, month, day, code_name, payee, summary, amount, job_no, job_manager, claim_flag, charge_flag, ref_no, status, remarks, new, new_date, renew, renew_date) VALUES ('"+dEmpno+"','"+year+"','"+tmonth+"','"+branch_no2+"','"+dYear+"','"+dMonth+"','"+dDay+"','"+dCodename+"','"+dPayee+"','"+dSummary+"','"+dPrice+"','"+dJobno+"','"+dJobmanager+"','"+dClaimflag+"','"+charge_flag+"', '"+dRefno+"','"+dStasus+"','"+dMemo+"','"+dNew+"','"+dNewdate+"','"+dNew+"','"+dNewdate+"') ; INSERT INTO TeComments (emp_no, sheet_year, sheet_month, branch_no, app_class, job_manager, app_flag, comment, new, new_date, renew, renew_date) VALUES ('"+dEmpno+"','"+year+"','"+tmonth+"','"+branch_no2+"','"+0+"','"+111+"','"+0+"','"+''+"','"+dNew+"','"+dNewdate+"','"+dNew+"','"+dNewdate+"')";
    console.log(sql)
